...
var Cliente = exports["default"] = /*#__PURE__*/function () {
  function Cliente(nombre) {
    ...
    _classPrivateFieldSet(_impuestos, this, null);
  }
  _createClass(Cliente, [{
    ...
    key: "setImpuestos",
    value: function setImpuestos(impuestos) {
      _classPrivateFieldSet(_impuestos, this, impuestos);
    }
  }, {
    key: "calcularImpuesto",
    value: function calcularImpuesto(porcentajeImpuesto) {
      if (!_classPrivateFieldGet(_impuestos, this)) {
        console.log("Error: impuestos no definidos para el cliente");
        return;
      }
      var total = _classPrivateFieldGet(_impuestos, this).montoBrutoAnual - _classPrivateFieldGet(_impuestos, this).deducciones;
